  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mx-4 md:mx-8">
        ...
        <ProjectCard src={startpage} title="RadioGuessr" description="I built a webgame in which you guess the location of a live radio stream on a 3D globe." projectLink="https://radioguessr.space/" githubLink={"https://github.com/barryspacezero/RadioGuessr"} />
